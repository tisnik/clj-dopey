...
(deftest test-select-word-class-id-existence
    ...
    (testing "if the clj-dopey.db-interface/select-word-class-id definition exists."
...
(deftest test-insert-word-into-dictionary-existence
    ...
    (testing "if the clj-dopey.db-interface/insert-word-into-dictionary definition exists."
