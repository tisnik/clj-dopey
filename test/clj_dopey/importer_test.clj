...
(deftest test-get-word-class-exception-handling
  "Check the function get-word-class"
  (testing "Function get-word-class"
           (with-redefs [db-interface/select-word-class-id
                           (fn [input] (throw (new Exception "exception")))]
...
(deftest test-get-source-exception-handling
  "Check the function get-source"
  (testing "Function get-source"
           (with-redefs [db-interface/select-source-id
                           (fn [input] (throw (new Exception "exception")))]
...
(deftest test-import-data-return-value
  ...
  (testing
    "import-data"
    (with-redefs
      [get-word-class (fn [input] "adverb")
       get-source (fn [input] "source")
       db-interface/insert-word-into-dictionary
         (fn
           [term description word-class use-it incorrect-forms correct-forms see-also internal verified copyrighted source]
           term)]
